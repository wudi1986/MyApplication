...
//				Tools.getLog(Tools.i, "aaa", "cookies.toString() = "
...
//			}
			...
			// Tools.getLog(Tools.i, "motel168", "retSrc:" + retSrc);
			...
			e.printStackTrace();
			if (++time >= 2)
				httpPostListener.connFail("链接超时");
			else
				doHttpGetJSON(uri, httpPostListener);
		} catch (Exception e) {
			e.printStackTrace();
...
//							.getValue().toString();
//					Tools.getLog(Tools.i, "aaa", "getAllHeaders = "+fileValue);
//					String cookie = Tools.spit(fileValue, "mg_auth");
//					if (cookie != null) {
//						LoginActivity.cookies = cookie;
//						Tools.getLog(Tools.i, "aaa", "LodingActivity.cookies ======== "
...
//						.toString());
//				Tools.getLog(Tools.i, "aaa", "cookie = " + LoginActivity.cookies.toString());
//			}
...
//		}
		...
		String strResult = EntityUtils.toString(httpresponse.getEntity());
		Tools.getLog(Tools.i, "aaa", "strResult = " + strResult);
		httpPostListener.connSuccess(strResult);
...
//	    conn.setRequestProperty("cookie", LoginActivity.cookies); 
	    ...
	    // �����ļ����?
    	Tools.getLog(Tools.i, "aaa", "files = "+files);
	    if(files != null){
	    	Tools.getLog(Tools.i, "aaa", "files = "+files);
	    ...
	    Tools.getLog(Tools.i, "aaa", "sb2 = "+sb2.toString());
	    }
