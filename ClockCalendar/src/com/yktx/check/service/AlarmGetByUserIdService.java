...
public class AlarmGetByUserIdService extends Service{
	...
	public AlarmGetByUserIdService(String requestType,
			Hashtable<String, String> params, String urlParams,
			ServiceListener serviceListener) {
		super(requestType, params, urlParams, serviceListener);
		// TODO Auto-generated constructor stub
		this.url = UrlParams.IP + Contanst.HTTP_ALARM_GETBYUSERID+urlParams;
...
//				String str = result.getString("message");
				...
				serviceListener.getJOSNdataSuccess(list, retcode , Contanst.ALARM_GETBYUSERID);
			} else {
				String errmsg = (String) result.get("message");
				serviceListener.getJOSNdataFail(erroCodeParse(retcode), errmsg, Contanst.ALARM_GETBYUSERID);
			}
		} catch (JSONException e) {
			serviceListener.getJOSNdataFail("", "服务器异常", Contanst.ALARM_GETBYUSERID);
			e.printStackTrace();
		}
	}
	...
	void httpFail(String erro) {
		// TODO Auto-generated method stub
		serviceListener.getJOSNdataFail("", "网络异常", Contanst.ALARM_GETBYUSERID);
