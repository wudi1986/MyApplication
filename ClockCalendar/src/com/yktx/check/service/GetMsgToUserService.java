...
public class GetMsgToUserService extends Service{

	public GetMsgToUserService(String requestType,
			Hashtable<String, String> params, String urlParams,
			ServiceListener serviceListener) {
		super(requestType, params, urlParams, serviceListener);
		// TODO Auto-generated constructor stub
		this.url=UrlParams.IP+Contanst.HTTP_GET_MSGTOUSER+urlParams;
	...
	void httpSuccess(String reponse) {
		...
		try {
			...
			if (Contanst.HTTP_SUCCESS.equals(retcode)) {//成功获取数据
				...
				Gson gson = new Gson();
				MsgToUserBean msgToUserBean = gson.fromJson(message, MsgToUserBean.class);
				serviceListener.getJOSNdataSuccess(msgToUserBean, retcode , Contanst.GET_MSGTOUSER);
			} else {
				String errmsg = (String) result.get("message");
				serviceListener.getJOSNdataFail(erroCodeParse(retcode), errmsg, Contanst.GET_MSGTOUSER);
			}
	...
	void httpFail(String erro) {
		// TODO Auto-generated method stub
		serviceListener.getJOSNdataFail("", "网络异常", Contanst.GET_MSGTOUSER);
