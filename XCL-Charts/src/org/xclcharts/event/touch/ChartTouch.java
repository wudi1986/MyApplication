...
//		 		Log.i(  "aaa", "mChart.getBottom() =========== "+mChart.getBottom());
	 ...
	 public void handleTouch_PanMode(MotionEvent event) {
		    ...
		    if ( action == MotionEvent.ACTION_MOVE) {
			      ...
			      {			    	    	  			    	  
				        ...
				        {
				        	setLocation(oldX,oldY,newX,oldY );			          				        
					        oldX = newX;
					        oldY = newY;					        
				        }			        
			      }			      			      
	       ...
	       // }
	    	 ...
	    	 if(mChart.getCtlPanRangeStatus())
	    	 {
	    		 ...
	    		 if(xx > 0)
	    			 return;
//	    		 Log.i(  "aaa", "xx ============ "+xx);
//	    		 Log.i(  "aaa", "mChart.getPlotArea().getPlotWidth() ============ "+mChart.getPlotArea().getPlotWidth());
//	    		 if(mChart.getPlotArea().getPlotWidth() < 0){
//	    			 
//	    		 }
